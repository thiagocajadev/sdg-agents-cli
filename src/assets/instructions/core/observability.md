...
> [!NOTE]
> Universal observability principles and stack-specific implementation guidance. For architectural guidelines, consult [Staff DNA](./staff-dna.md), [Engineering Standards](./engineering-standards.md), and [Security Strategy](./security.md).
