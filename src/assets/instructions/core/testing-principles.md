# Testing Principles — Quality without Overengineering
...
- **Security Tests**: DAST, fuzzing, and exploit simulation are part of the pipeline — not optional. See [Security Pipeline](.ai/instructions/core/security-pipeline.md) Phase 4 for runtime security validation rules.
