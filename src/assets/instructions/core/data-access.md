...
> For SQL scansion, indentation, and aesthetic standards, refer to the [SQL Style Guide](.ai/instructions/core/sql-style.md).
...
> [!NOTE]
> Database interactions must follow the **SDG Linear Flow Style** as defined in the [SQL Style Guide](.ai/instructions/core/sql-style.md).
