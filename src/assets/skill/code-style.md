...
> Load in **Phase CODE** alongside `staff-dna`. For SQL-specific aesthetics, load the SQL Style skill. <!-- TBD: .ai/skill/sql-style.md -->
...
- Security Skill rules passed. <!-- TBD: .ai/skill/security.md -->
