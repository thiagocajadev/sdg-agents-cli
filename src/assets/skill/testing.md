...
- **Security Tests**: DAST, fuzzing, and exploit simulation are part of the pipeline — not optional. See the Security skill Phase 4 for runtime security validation rules. <!-- TBD: .ai/skill/security.md -->
